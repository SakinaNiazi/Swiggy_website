...
<head>
  ...
  <title>Message and feedback</title>
      ...
      <aside id="left-sidebar-nav">
        <ul id="slide-out" class="side-nav fixed leftside-navigation">
            ...
            <li class="bold"><a href="index.php" class="waves-effect waves-cyan"><i class="mdi-editor-border-color"></i> Order Food</a>
                ...
                <li class="no-padding">
                    <ul class="collapsible collapsible-accordion">
                        <li class="bold"><a class="collapsible-header waves-effect waves-cyan active"><i class="mdi-action-question-answer"></i> F&M</a>
                            <div class="collapsible-body">
                                <ul>
								<li class="<?php
          ...
          <div class="container">
            <div class="row">
              <div class="col s12 m12 l12">
                <h5 class="breadcrumbs-title">M&F</h5>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="divider"></div>
            <div class="row">
              <div class="col s12 m4 l3">
                <h4 class="header">just contact us or give us a message!</h4>
              </div>
<div>
                    ...
                    <form class="formValidate" id="formValidate" method="post" action="routers/add-ticket.php" novalidate="novalidate" class="col s12">
                      ...
                      <div class="row">
                        <div class="input-field col s4">
							<select name="type">
								<option disabled selected>wants help</option>
      ...
      <!-- END CONTENT -->
	        ...
	        <!--start container-->
        <div class="container">
          <p class="caption">List of your message</p>
          <div class="divider"></div>
  ...
  <footer class="page-footer">
    <div class="footer-copyright">
      <div class="container">
        ...
        <span class="right"> Design and Developed by <a class="grey-text text-lighten-4" href="#">Niazi</a></span>
        </div>
    </div>
  </footer>
    <!-- END FOOTER -->
